...
class _WorkoutCardState extends State<WorkoutCard> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        BlocProvider.of<ProgramsCubit>(context).navigateToDetailed(
            context: context, workoutProgram: widget.workoutProgram);
      },
      child: Card(
        color: Theme.of(context).colorScheme.primaryContainer,
        child: Padding(
          padding:
              const EdgeInsets.only(top: 8, bottom: 10, right: 15, left: 15),
          child: Column(
